      ...
      <div style={{ width: "100%", maxWidth: 380 }} className="animate-fade">
        ...
        <div className="card" style={{ padding: 28 }}>
          ...
          <form onSubmit={handle} style={{ display: "flex", flexDirection: "column", gap: 10 }}>
            ...
            <button type="submit" className="btn btn-primary" disabled={loading} style={{ marginTop: 4, padding: "13px", fontSize: 15 }}>
              {loading ? "..." : mode === "login" ? "Войти →" : "Зарегистрироваться →"}
            </button>
          </form>
          <button onClick={() => { setMode(m => m === "login" ? "register" : "login"); setError(""); }}
            style={{ width: "100%", marginTop: 16, fontSize: 13, color: "#7F77DD", background: "none", border: "none", textAlign: "center", cursor: "pointer" }}>
