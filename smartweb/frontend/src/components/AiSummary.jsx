...
import { useTranslation } from 'react-i18next'// Shared post-call AI summary panel. WHY: Lead and Member dashboards rendered
...
export default function AiSummary({ summary }) {
  ...
  return (
    <div style={{ marginTop: 10, padding: '10px 14px', background: 'var(--blue-50)', borderRadius: 8, border: '1px solid var(--blue-200)', borderLeft: '3px solid var(--color-accent)' }}>
      <p style={{ fontSize: 11, fontWeight: 700, color: 'var(--color-accent)', marginBottom: 5, letterSpacing: '0.06em', textTransform: 'uppercase' }}>{t('ui.ai_rezyume')}</p>
