...
// Единый журнал аудита (Блок 8) — только для владельческой админ-панели.
export const getAuditLog = (params) => api.get('/admin/audit/', { params })
export const getAuditEntry = (id) => api.get(`/admin/audit/${id}`)
export const getAuditSecuritySummary = () => api.get('/admin/audit/security-summary')
